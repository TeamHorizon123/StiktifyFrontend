...
const SettingListenHistory: React.FC<SettingListenHistoryProps> = ({
  ...
  return (
    <div className="w-[100%] bg-[#18182c] text-white p-4 rounded-lg">
      <div className="mb-4 flex items-center gap-2">
        <label className="text-md font-medium">Date: </label>
        <DatePicker className="w-[200px] mt-1" onChange={handleDateChange} />
      </div>
      <div
        className="mb-4 w-[250px] flex items-center gap-2 p-2 rounded-lg cursor-pointer hover:bg-gray-200 hover:text-black transition"
        onClick={handlePauseResumeHistory}
      >
        {isMusicPaused ? <FaPlay className="text-purple-500" size={20} /> : <FaPause className="text-purple-500" size={20} />}
