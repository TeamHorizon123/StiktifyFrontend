...
import { FaCartShopping, FaReceipt } from "react-icons/fa6";
...
export default function Search() {
    ...
    useEffect(() => {
        const getCountCart = async () => {
            try {
                ...
                setCountCart(res["@odata.count"] ?? 0);
            } catch (error) {
                console.error(error);
            }
        }
    ...
    return (
        <div className="">
            <div className="w-full mt-6 flex items-center justify-center relative space-x-6" ref={wrapperRef}>
                <div className="flex flex-col">
                    ...
                    {
                        searchValue && (
                            <div className="p-4 min-w-60 w-[30vw] h-[50vh] bg-[#1C1B33] absolute top-full mt-1 rounded-md shadow-lg z-50 overflow-y-auto space-y-2">
                                {
                                    loading ? (
