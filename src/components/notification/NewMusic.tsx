...
interface NewMusicNotificationProps {
  notification: {
    _id: string;
    recipient: string;
...
const NewMusicNotification: React.FC<NewMusicNotificationProps> = ({
  notification,
  setUnreadCount,
  setNotifications,
}) => {
      ...
      <div className="flex items-start" onClick={handlePostClick}>
        ...
        <div className="flex-1">
          <p className="text-sm">
            ...
            <span className="text-gray-600">just posts a music.</span>
          </p>
...
export default NewMusicNotification;
