...
interface ReactPostNotificationProps {
  notification: {
    _id: string;
    recipient: string;
...
const ReactPostNotification: React.FC<ReactPostNotificationProps> = ({
  notification,
  setUnreadCount,
  setNotifications,
}) => {
      ...
      <div className="flex items-center" onClick={handlePostClick}>
        ...
        <div className="ml-4">
          <p className="text-sm text-zinc-800">
            ...
            <span className="text-zinc-500">just reacts in your post.</span>
          </p>
...
export default ReactPostNotification;
