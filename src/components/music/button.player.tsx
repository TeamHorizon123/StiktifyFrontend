...
const ButtonPlayer = (props: IProps) => {
  ...
  return (
    <button
      ...
      className={`w-12 h-12 flex items-center justify-center bg-purple-500 hover:bg-purple-400 transition rounded-full shadow-md ${className}`}
    >
      {isPlaying && trackCurrent?._id === current ? (
        <FaPause size={24} />
      ) : (
